...
filtert1 = HPCmonthlyTmean(HPCmonthlyTime(:,1) >= 2016 & HPCmonthlyTime(:,1) < 2046 & HPCmonthlyTime(:,2) == 3,:);
filterp1 = HPCmonthlyPtot(HPCmonthlyTime(:,1) >= 2016 & HPCmonthlyTime(:,1) < 2046 & HPCmonthlyTime(:,2) == 3,:);

filtert2 = HPCmonthlyTmean(HPCmonthlyTime(:,1) >= 2066 & HPCmonthlyTime(:,1) < 2096 & HPCmonthlyTime(:,2) == 3,:);
filterp2 = HPCmonthlyPtot(HPCmonthlyTime(:,1) >= 2066 & HPCmonthlyTime(:,1) < 2096 & HPCmonthlyTime(:,2) == 3,:);
...
for m = 3 % Change this for the required month
...
%% Raincloud May
filtert1=HPCmonthlyTmean(HPCmonthlyTime(:,1)>=2016 & HPCmonthlyTime(:,1)<2046 & HPCmonthlyTime(:,2)==6,:);
filterp1=HPCmonthlyPtot(HPCmonthlyTime(:,1)>=2016 & HPCmonthlyTime(:,1)<2046 & HPCmonthlyTime(:,2)==6,:);
 
filtert2=HPCmonthlyTmean(HPCmonthlyTime(:,1)>=2066 & HPCmonthlyTime(:,1)<2096 & HPCmonthlyTime(:,2)==6,:);
filterp2=HPCmonthlyPtot(HPCmonthlyTime(:,1)>=2066 & HPCmonthlyTime(:,1)<2096 & HPCmonthlyTime(:,2)==6,:);
...
May=[];
Months_new=[];
for m=6 % change this for the required month 4=april etc
...
%% Raincloud sept
filtert1=HPCmonthlyTmean(HPCmonthlyTime(:,1)>=2016 & HPCmonthlyTime(:,1)<2046 & HPCmonthlyTime(:,2)==8,:);
filterp1=HPCmonthlyPtot(HPCmonthlyTime(:,1)>=2016 & HPCmonthlyTime(:,1)<2046 & HPCmonthlyTime(:,2)==8,:);
 
filtert2=HPCmonthlyTmean(HPCmonthlyTime(:,1)>=2066 & HPCmonthlyTime(:,1)<2096 & HPCmonthlyTime(:,2)==8,:);
filterp2=HPCmonthlyPtot(HPCmonthlyTime(:,1)>=2066 & HPCmonthlyTime(:,1)<2096 & HPCmonthlyTime(:,2)==8,:);
...
xline(2, '--', LineWidth=1)
set(gca,'Ytick',[0,0.05,0.1,0.15,0.2,0.25,0.3])
title("August", "FontWeight", "normal")
set(gca, 'XLim', [-25 25]);
set(gca,'Xtick',[])
set(h1{1}, 'LineWidth', 1)
set(h2{1}, 'LineWidth', 1)
...
Sept=[];
Months_new=[];
for m=8 % change this for the required month 4=april etc etc
...
grid
%% Raincloud Oct
filtert1=HPCmonthlyTmean(HPCmonthlyTime(:,1)>=2016 & HPCmonthlyTime(:,1)<2046 & HPCmonthlyTime(:,2)==11,:);
filterp1=HPCmonthlyPtot(HPCmonthlyTime(:,1)>=2016 & HPCmonthlyTime(:,1)<2046 & HPCmonthlyTime(:,2)==11,:);
 
filtert2=HPCmonthlyTmean(HPCmonthlyTime(:,1)>=2066 & HPCmonthlyTime(:,1)<2096 & HPCmonthlyTime(:,2)==11,:);
filterp2=HPCmonthlyPtot(HPCmonthlyTime(:,1)>=2066 & HPCmonthlyTime(:,1)<2096 & HPCmonthlyTime(:,2)==11,:);
...
xline(2, '--', LineWidth=1)
set(gca,'Ytick',[0,0.05,0.1,0.15,0.2,0.25,0.3])
title("November", "FontWeight", "normal")
set(gca, 'XLim', [-25 25]);
...
Oct=[];
Months_new=[];
for m=11 % change this for the required month 4=april etc etc
...
Apr=[];
Months_new=[];
for m=3 % change this for the required month 4=april etc etc
Apr=vertcat(Apr,[Preciptot20162046(:,m);Preciptot20662096(:,m)]);
Year_new=vertcat(Year_new,[repmat([2016],length(Preciptot20162046(:,m)),1); repmat([2066],length(Preciptot20662096(:,m)),1)]);   
Months_new=vertcat(Months_new,repmat([m],length(Preciptot20162046)*2,1));
end
...
May=[];
Months_new=[];
for m=6 % change this for the required month 4=april etc etc
May=vertcat(May,[Preciptot20162046(:,m);Preciptot20662096(:,m)]);
Year_new=vertcat(Year_new,[repmat([1990],length(Preciptot20162046(:,m)),1); repmat([2070],length(Preciptot20662096(:,m)),1)]);   
Months_new=vertcat(Months_new,repmat([m],length(Preciptot20162046)*2,1));
end
...
print(gcf, 'Appendix_F.png', '-dpng', '-r300')