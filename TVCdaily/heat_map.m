...
close all
clear
cd /Users/johnnyrutherford/'OneDrive - Northumbria University - Production Azure AD'/Documents/MATLAB/TVCdaily/h1
...
pcolor([1:366],(y(1:21)),(GTmedian1depth_P1(1:21,:))); shading interp; colormap parula
hold on
clim([min(GTmedian1depth_P1(:)) max(GTmedian1depth_P1(:))]);
c1 = contour([1:366],(y(1:21)),(GTmedian1depth_P1(1:21,:)),[0.75 0.75], '-k', 'LineWidth', 2)
hold on
...
% xfill=[x_low, flip(x_high)]
% yfill=[y_low, flip(y_high)]
% fill(xfill,yfill, 'black', "FaceAlpha", 0.2, "LineStyle", "none")

% fill([x_low, flip(x_high)], [y_low, flip(y_high)], 'k', 'EdgeColor', 'none');
% contourf([1:366],(y(1:20)),(GTmedian1depth_P1(1:20,:)),[-0.75 -0.75]

title('2016-2046', 'FontWeight','normal');
ytext = {'Soil Depth (m)'};
ylabel(ytext);
% ylabel({'\textbf{Jordan}', 'Soil Depth (m)'}, 'Interpreter', 'latex');
...
%% sturm rcp45 present 
clearvars -except GTmedian1depth_P1
cd /Users/johnnyrutherford/'OneDrive - Northumbria University - Production Azure AD'/Documents/MATLAB/TVCdaily/sturm/h1
% cd D:/MATLAB/TVCdaily/h1
...
% 
% fill([x_low, flip(x_high)], [y_low, flip(y_high)], 'k', 'EdgeColor', 'none');
% contour([1:366],(y(1:20)),(GTmedian1depth_P2(1:20,:)),[0 0],'k-','LineWidth',2)
clim([min(GTmedian1depth_P1(:)) max(GTmedian1depth_P1(:))]);
title('2016-2046', 'FontWeight','normal');
% ylabel('Soil Depth (m)')
