...
# Data guide
The data needed to produce the figures is available at: https://livenorthumbriaac-my.sharepoint.com/:f:/g/personal/w22026593_northumbria_ac_uk/Em_alPVqMZZJhEs-L-MaGvoBQMg34Lk63sheijq6L560PQ?e=1eylaq
The data should be downloaded in the file structure as shown in the onedrive link. Open the folder named 'data' and set this as the matlab working directory. From here the figures can be reproduced using the scripts included in the repository.
